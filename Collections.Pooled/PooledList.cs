...
#pragma warning restore IDE0044
        ...
        /// <summary>
        /// Gets a <see cref="Memory{T}"/> for the items currently in the collection.
        /// WARNING: Be careful not to modify the list until you're finished with the returned 
        /// <see cref="Memory{T}"/>. Actions that change the size of the list will not affect
        /// the length of the Memory, and may invalidate the Memory entirely by making changes to the backing store.
        /// Continuing to use the Memory after making changes to the PooledList is NOT guaranteed to work.
        /// </summary>
        ...
        /// WARNING: Be careful not to modify the list until you're finished with the returned 
        /// <see cref="ReadOnlyMemory{T}"/>. Actions that change the size of the list will not affect
        /// the length of the Memory, and may invalidate the Memory entirely by making changes to the backing store.
        /// Continuing to use the Memory after making changes to the PooledList is NOT guaranteed to work.
        /// </summary>
        ReadOnlyMemory<T> IReadOnlyPooledList<T>.Memory => Memory;
