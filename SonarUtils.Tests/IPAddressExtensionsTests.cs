...
namespace SonarUtils.Tests
{
    ...
    // all merged, with multicast and broadcast tests added

    public static class IPAddressExtensionsTests
    {
        [Theory]
        ...
        public static void IsPrivate_ReturnsFalse(string ip)
        {
        ...
        [InlineData("ffee:1234::1")] // Multicast
        public static void IsPrivate_ReturnsTrue(string ip)
        {
            var ipAddress = IPAddress.Parse(ip);
