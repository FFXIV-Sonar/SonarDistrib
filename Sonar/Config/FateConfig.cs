...
namespace Sonar.Config
{
    ...
    public class FateConfig : RelayConfig
    {
        ...
        public FateConfig(FateConfig c) : base(c)
        {
            this.DefaultJurisdiction = c.DefaultJurisdiction;
        ...
        [Key("jurisdiction")]
        [EditorBrowsable(EditorBrowsableState.Never)]
        public Dictionary<uint, SonarJurisdiction> Jurisdiction { get; set; } = new Dictionary<uint, SonarJurisdiction>();
        ...
        {
            return this.Jurisdiction.GetValueOrDefault(id, SonarJurisdiction.Default);
        }
