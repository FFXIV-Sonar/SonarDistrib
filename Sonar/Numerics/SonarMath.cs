...
{
    [SuppressMessage("Major Code Smell", "S3358:Ternary operators should not be nested", Justification = "Intentional")]
    [SuppressMessage("Minor Code Smell", "S4136:Method overloads should be grouped together", Justification = "<Pending>")]
    [SuppressMessage("Minor Code Smell", "S1905:Redundant casts should not be used", Justification = "<Pending>")]
    [SuppressMessage("Security", "CA5394:Do not use insecure randomness", Justification = "Not applicable.")]
    public static class SonarMath
    {
        private static readonly ThreadLocal<Random> _random = new(() => new Random());

        /// <summary>Normal thread local random.</summary>
        public static Random Random => _random.Value!;
        
        /// <summary>Clamps the value between a minimum and maximum value.</summary>
        public static sbyte Clamp(this sbyte value, sbyte min, sbyte max) => value < min ? min : value > max ? max : value;

        /// <summary>Clamps the value with a minimum value.</summary>
        public static sbyte ClampMin(this sbyte value, sbyte min) => value < min ? min : value;

        /// <summary>Clamps the value with a maximum value.</summary>
        public static sbyte ClampMax(this sbyte value, sbyte max) => value > max ? max : value;

        /// <summary>Check if the value roughly equals another value.</summary>
        ...
        /// <summary>Return the lowest of two values.</summary>
        public static sbyte Min(this sbyte v1, sbyte v2) => v1 < v2 ? v1 : v2;

        /// <summary>Return the highest of two values.</summary>
        ...
        /// <summary>Return the absolute value.</summary>
        ...
        /// <summary>Return truncated value.</summary>
        ...
        /// <summary>Return a value varied by up to the specified amount.</summary>
